...
![screenshot](https://private-user-images.githubusercontent.com/9608686/521247414-af68bacb-ba03-4a0f-ba6f-317621c8c659.png?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..LvNfY0zTiohQViZ1DXNf-gtuKzzNlC3_0uRDl3VdD8k)
...
This app is automatically built and published to GitHub Pages via a GitHub Actions workflow. The workflow:

- Downloads the latest `PSI-MOD.obo` file from the [HUPO-PSI/psi-mod-CV](https://github.com/HUPO-PSI/psi-mod-CV) repository
- Runs a production build (`vite build`) and publishes to GitHub Pages
- Is triggered on pushes to `main`, manual dispatch, or automatically when `PSI-MOD.obo` is updated in the source repository

Notes for contributors:

- Locally, the app loads the OBO file from `src/assets/data/PSI-MOD.obo` (imported as raw text). In CI, the workflow downloads the latest file to that path before building.
